...
classifier = RandomForestClassifier(n_estimators = 1400, criterion = 'entropy', min_samples_split = 5, min_samples_leaf = 4, max_features = 'sqrt', max_depth = 80,bootstrap = True)
